<nav id="sidebar">
    <div id="main-menu">
        <ul class="sidebar-nav">
            ...
            <li><a href="#"><i class="glyph-icon flaticon-panels"></i><span
            ...
            <li><a href="#"><i class="glyph-icon flaticon-account"></i><span
                    class="sidebar-text">Mi Cuenta</span><span class="fa arrow"></span></a>
                <ul class="submenu collapse">
                    <li><a href="#"><span class="sidebar-text">Mi Perfil</span></a>
                    </li>
                    <li><a href="#"><span class="sidebar-text">Configuración
                                de Cuenta</span></a>
                    </li>
                    ...
                    <li><a href="#"><span class="sidebar-text">Lockscreen</span></a>
                    </li>
                    <li><a href="#"><span class="sidebar-text">Logout</span></a>
                    </li>
                </ul>
            </li>
            <li><a href="#"><i class="glyph-icon flaticon-account"></i><span
                ...
                <ul class="submenu collapse">
                    <li><a href="#"><span class="sidebar-text">Crear</span></a>
                    </li>
            ...
            <li><a href="#"><i class="glyph-icon flaticon-ui-elements2"></i><span
                    class="sidebar-text">Clientes</span><span class="fa arrow"></span></a>
                <ul class="submenu collapse">
                    <li><a href="#"><span class="sidebar-text">Recepción</span></a>
                    </li>
