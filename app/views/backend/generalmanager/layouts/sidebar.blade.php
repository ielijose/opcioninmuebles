<nav id="sidebar">
    <div id="main-menu">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="#"><i class="glyph-icon flaticon-panels"></i><span class="sidebar-text">Sucursales</span><span class="fa arrow"></span></a>
                <ul class="submenu collapse">
                    <li><a href="panels.html"><span class="sidebar-text">Crear</span></a></li>
                    <li><a href="panels_draggable.html"><span class="sidebar-text">Modificar</span></a></li>
                    <li><a href="panels_draggable.html"><span class="sidebar-text">Eliminar</span></a></li>
                    <li><a href="panels_draggable.html"><span class="sidebar-text">Consultar</span></a></li>
                </ul>
            </li>
            <li>
                <a href="#"><i class="glyph-icon flaticon-account"></i><span class="sidebar-text">Mi Cuenta</span><span class="fa arrow"></span></a>
                <ul class="submenu collapse">
                    <li><a href="#"><span class="sidebar-text">Mi Perfil</span></a></li>
                    <li><a href="#"><span class="sidebar-text">Configuración de Cuenta</span></a></li>
                    <li><a href="#"><span class="sidebar-text">Registrar Usuarios</span></a></li>
                    <li><a href="password_forgot.html"><span class="sidebar-text">Recuperar Contraseña</span></a></li>
                    <li><a href="#"><span class="sidebar-text">Lockscreen</span></a></li>
                    <li><a href="#"><span class="sidebar-text">Logout</span></a></li>
                </ul>
            </li>
            <li>
