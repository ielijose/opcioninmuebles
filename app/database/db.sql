...
-- Volcando estructura para tabla sabuesoonline.answers
...
-- Volcando datos para la tabla sabuesoonline.answers: ~5 rows (aproximadamente)
DELETE FROM `answers`;
/*!40000 ALTER TABLE `answers` DISABLE KEYS */;
INSERT INTO `answers` (`id`, `answer`, `question_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, 'dfhdfhdfh', 4, 4, '2014-08-29 15:08:55', '2014-08-29 15:08:55'),
	(2, 'asfasfasf', 1, 4, '2014-09-01 12:07:01', '2014-09-01 12:07:01'),
	(3, 'si llegan y los correos tambien', 7, 3, '2014-09-01 21:45:36', '2014-09-01 21:45:36'),
	(4, 'sdvsdvsdfvsfdvs\r\n', 6, 3, '2014-09-01 21:46:04', '2014-09-01 21:46:04'),
	(5, 'zfdvsadvsdf sdfsw dfsad fsadf sw', 5, 3, '2014-09-01 21:46:17', '2014-09-01 21:46:17');
/*!40000 ALTER TABLE `answers` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.categories
...
-- Volcando datos para la tabla sabuesoonline.categories: ~13 rows (aproximadamente)
DELETE FROM `categories`;
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT INTO `categories` (`id`, `category`, `class`, `created_at`, `updated_at`) VALUES
	(1, 'Deportes', 'icon-cat-deportes', '2014-07-30 18:02:29', '2014-07-30 18:02:29'),
	(2, 'Empleos', 'icon-cat-empleos', '2014-07-30 18:02:36', '2014-07-30 18:02:36'),
	(3, 'Empresas', 'icon-cat-empresas', '2014-07-30 18:02:42', '2014-07-30 18:02:42'),
	(4, 'Hogar', 'icon-cat-hogar', '2014-07-30 18:02:47', '2014-07-30 18:02:47'),
	(5, 'Industria', 'icon-cat-industria', '2014-07-30 18:02:52', '2014-07-30 18:02:52'),
	(6, 'Mascotas', 'icon-cat-mascotas', '2014-07-30 18:02:57', '2014-07-30 18:02:57'),
	(7, 'Salud', 'icon-cat-salud', '2014-07-30 18:03:02', '2014-07-30 18:03:02'),
	(8, 'Moda', 'icon-cat-moda', '2014-07-30 18:03:08', '2014-07-30 18:03:08'),
	(9, 'Musica', 'icon-cat-musica', '2014-07-30 18:03:32', '2014-07-30 18:03:32'),
	(10, 'Tecnologia', 'icon-cat-tecnologia', '2014-07-30 18:03:37', '2014-07-30 18:03:37'),
	(11, 'Transporte', 'icon-cat-transporte', '2014-07-30 18:03:44', '2014-07-30 18:03:44'),
	(12, 'Viajes', 'icon-cat-viajes', '2014-07-30 18:03:49', '2014-07-30 18:03:49'),
	(13, 'Servicios', 'icon-cat-servicios', '2014-07-30 18:03:55', '2014-07-30 18:03:55');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.ciudades
CREATE TABLE IF NOT EXISTS `ciudades` (
  ...
  CONSTRAINT `FK_ciudades_estados` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=523 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla sabuesoonline.ciudades: ~498 rows (aproximadamente)
...
-- Volcando estructura para tabla sabuesoonline.employs
CREATE TABLE IF NOT EXISTS `employs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `employ` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `salary` decimal(10,2) NOT NULL,
  `place` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `horary` enum('partial','full','guard') COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `employs_user_id_foreign` (`user_id`),
  CONSTRAINT `employs_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sabuesoonline.employs: ~0 rows (aproximadamente)
DELETE FROM `employs`;
/*!40000 ALTER TABLE `employs` DISABLE KEYS */;
/*!40000 ALTER TABLE `employs` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.employs_categories
CREATE TABLE IF NOT EXISTS `employs_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `employs_categories_employ_id_foreign` (`employ_id`),
  KEY `employs_categories_category_id_foreign` (`category_id`),
  CONSTRAINT `employs_categories_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
  CONSTRAINT `employs_categories_employ_id_foreign` FOREIGN KEY (`employ_id`) REFERENCES `employs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sabuesoonline.employs_categories: ~0 rows (aproximadamente)
DELETE FROM `employs_categories`;
/*!40000 ALTER TABLE `employs_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `employs_categories` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.estados
...
-- Volcando datos para la tabla sabuesoonline.estados: ~25 rows (aproximadamente)
DELETE FROM `estados`;
...
-- Volcando estructura para tabla sabuesoonline.images
CREATE TABLE IF NOT EXISTS `images` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `image` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `type` enum('classified','enterprise') COLLATE utf8_unicode_ci NOT NULL,
...
-- Volcando datos para la tabla sabuesoonline.images: ~12 rows (aproximadamente)
DELETE FROM `images`;
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
INSERT INTO `images` (`id`, `image`, `type`, `type_id`, `created_at`, `updated_at`) VALUES
	(1, '7TWfPlYWnLlvndFe_62B4C8A84.jpg', 'classified', 1, '2014-08-26 12:49:46', '2014-08-26 12:49:46'),
	(2, 'uYBImvodZjzevDmU_Chrysanthemum.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(3, 'syb3rNqGShUHXdiJ_Desert.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(4, 'xgqqX3NvhcuNwwfp_Hydrangeas.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(5, '5alakMWH3JYg7Dz4_Jellyfish.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(6, 'BiJfIvz5LOCASe5l_Koala.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(7, 'WobkDiaQnd3zllB2_Penguins.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(8, 'S5uoLjN2c0k8QoTk_Lighthouse.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(9, 'kyS1tWFXcOyRvRR0_Tulips.jpg', 'classified', 2, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(10, 'OCBTWDsKB9vOToPH_8680908102_3591e186d0_b.jpg', 'classified', 3, '2014-09-06 14:57:43', '2014-09-06 14:57:43'),
	(12, 'Zf3mVzlWXpOZmuan_rubik.jpg', 'classified', 5, '2014-09-12 09:39:40', '2014-09-12 09:39:40'),
	(13, 'vV276h9FGeVcVWgl_v_franklin_chop_2880x1800.jpg', 'classified', 5, '2014-09-12 09:39:40', '2014-09-12 09:39:40');
/*!40000 ALTER TABLE `images` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.knowledges
CREATE TABLE IF NOT EXISTS `knowledges` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `knowledge` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `type` enum('basic','important') COLLATE utf8_unicode_ci NOT NULL,
  `employ_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `knowledges_employ_id_foreign` (`employ_id`),
  CONSTRAINT `knowledges_employ_id_foreign` FOREIGN KEY (`employ_id`) REFERENCES `employs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sabuesoonline.knowledges: ~0 rows (aproximadamente)
DELETE FROM `knowledges`;
/*!40000 ALTER TABLE `knowledges` DISABLE KEYS */;
/*!40000 ALTER TABLE `knowledges` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.migrations
CREATE TABLE IF NOT EXISTS `migrations` (
  `migration` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `batch` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sabuesoonline.migrations: ~16 rows (aproximadamente)
DELETE FROM `migrations`;
/*!40000 ALTER TABLE `migrations` DISABLE KEYS */;
INSERT INTO `migrations` (`migration`, `batch`) VALUES
	('2014_07_04_134231_create_sabueso_app', 1),
	('2014_06_29_184529_create_geo_tables', 2),
	('2014_07_04_134828_create_user_app', 3),
	('2014_07_30_170020_create_categories_table', 3),
	('2014_08_01_004901_create_products_table', 3),
	('2014_08_01_005807_create_images_table', 3),
	('2014_08_01_010011_create_product_category_table', 3),
	('2014_08_15_151903_create_employs_table', 3),
	('2014_08_15_195843_create_knowledge_table', 3),
	('2014_08_16_003220_create_employ_category_table', 3),
	('2014_08_23_235628_create_password_reminders_table', 3),
	('2014_08_26_151229_create_questions_table', 4),
	('2014_08_29_144616_create_answers_table', 5),
	('2014_09_03_205724_create_notifications_table', 6),
	('2014_09_06_142840_add_condition_product', 7),
	('2014_09_06_142947_add_profilepicture_user', 7),
	('2014_09_09_230639_create_payments_table', 8);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.municipios
...
-- Volcando datos para la tabla sabuesoonline.municipios: ~335 rows (aproximadamente)
...
-- Volcando estructura para tabla sabuesoonline.notifications
...
-- Volcando datos para la tabla sabuesoonline.notifications: ~4 rows (aproximadamente)
DELETE FROM `notifications`;
/*!40000 ALTER TABLE `notifications` DISABLE KEYS */;
INSERT INTO `notifications` (`id`, `notification`, `type`, `type_id`, `is_read`, `sent_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, '<strong>Clasificados</strong> te ha hecho una pregunta.', 'question', 8, 0, 1, 2, '2014-09-04 00:07:50', '2014-09-04 00:07:50'),
	(2, '<strong>Clasificados</strong> te ha hecho una pregunta.', 'question', 9, 0, 3, 2, '2014-09-04 09:55:54', '2014-09-06 18:00:18'),
	(3, '<strong>Luis Padrón</strong> te ha hecho una pregunta.', 'question', 10, 0, 3, 2, '2014-09-04 10:04:24', '2014-09-06 15:58:15'),
	(4, 'Te ha hecho una pregunta.', 'question', 11, 1, 2, 2, '2014-09-16 12:10:11', '2014-09-16 12:10:26');
/*!40000 ALTER TABLE `notifications` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.parroquias
...
-- Volcando datos para la tabla sabuesoonline.parroquias: ~1.138 rows (aproximadamente)
...
-- Volcando estructura para tabla sabuesoonline.password_reminders
...
-- Volcando datos para la tabla sabuesoonline.password_reminders: ~0 rows (aproximadamente)
DELETE FROM `password_reminders`;
/*!40000 ALTER TABLE `password_reminders` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_reminders` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.payments
...
-- Volcando datos para la tabla sabuesoonline.payments: ~1 rows (aproximadamente)
DELETE FROM `payments`;
/*!40000 ALTER TABLE `payments` DISABLE KEYS */;
INSERT INTO `payments` (`id`, `efectivo`, `debito`, `transferencia`, `cheque`, `visa`, `mastercard`, `user_id`, `created_at`, `updated_at`) VALUES
	(5, 0, 1, 0, 1, 0, 0, 2, '2014-09-11 16:13:53', '2014-09-11 16:14:34');
/*!40000 ALTER TABLE `payments` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.products
CREATE TABLE IF NOT EXISTS `products` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `product` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `price` decimal(10,2) NOT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('online','offline','draft') COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `condition` enum('new','used','none') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'none',
  PRIMARY KEY (`id`),
  KEY `products_user_id_foreign` (`user_id`),
  CONSTRAINT `products_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sabuesoonline.products: ~4 rows (aproximadamente)
DELETE FROM `products`;
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`id`, `product`, `price`, `description`, `status`, `user_id`, `created_at`, `updated_at`, `condition`) VALUES
	(1, 'Flyboard hdisokad sad wrfsdf sfdfs dfsdf sdfsdf sdfsdfsdf sdfsdfsdfsf sdfsdfsdf sdfsdfsdfsdfsdfs', 15.00, 'asfasfasfasfasfasfasfasf', 'online', 1, '2014-08-26 12:49:46', '2014-09-01 14:27:13', 'none'),
	(2, 'prueba lpllplplplplplp lplplp lplplpl plplplp lplplpl plplplpl plplplp lplplpl plplplpl', 130.00, 'refw2f wdf wdefwdf wdfw dfwdf wdf wdfw dfw dfw dfw dfw dfw refw2f wdf wdefwdf wdfw dfwdf wdf wdfw dfw dfw dfw dfw dfw refw2f wdf wdefwdf wdfw dfwdf wdf wdfw dfw dfw dfw dfw dfw refw2f wdf wdefwdf wdfw dfwdf wdf wdfw dfw dfw dfw dfw dfw refw2f wdf wdefwdf ', 'online', 3, '2014-09-01 21:28:08', '2014-09-01 21:28:08', 'none'),
	(3, 'Fasf', 0.00, 'asfasf', 'online', 1, '2014-09-06 14:57:43', '2014-09-06 14:57:43', 'none'),
	(5, 'Tabla de surf', 5000.00, 'Tabla de surf', 'online', 2, '2014-09-12 09:39:40', '2014-09-12 09:39:40', 'new');
/*!40000 ALTER TABLE `products` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.products_categories
...
-- Volcando datos para la tabla sabuesoonline.products_categories: ~10 rows (aproximadamente)
DELETE FROM `products_categories`;
/*!40000 ALTER TABLE `products_categories` DISABLE KEYS */;
INSERT INTO `products_categories` (`id`, `product_id`, `category_id`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '2014-08-26 12:49:46', '2014-08-26 12:49:46'),
	(2, 1, 10, '2014-08-26 12:49:46', '2014-08-26 12:49:46'),
	(3, 2, 12, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(4, 2, 10, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(5, 2, 11, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(6, 2, 7, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(7, 2, 9, '2014-09-01 21:28:08', '2014-09-01 21:28:08'),
	(8, 3, 6, '2014-09-06 14:57:43', '2014-09-06 14:57:43'),
	(11, 5, 1, '2014-09-12 09:39:40', '2014-09-12 09:39:40'),
	(12, 5, 6, '2014-09-12 09:39:40', '2014-09-12 09:39:40');
/*!40000 ALTER TABLE `products_categories` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.questions
CREATE TABLE IF NOT EXISTS `questions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `question` text COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('unread','read','responded','ignored') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'unread',
  `product_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
-- Volcando datos para la tabla sabuesoonline.questions: ~11 rows (aproximadamente)
DELETE FROM `questions`;
/*!40000 ALTER TABLE `questions` DISABLE KEYS */;
INSERT INTO `questions` (`id`, `question`, `status`, `product_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, 'pregunta', 'responded', 1, 1, '2014-08-29 15:22:30', '2014-09-01 12:07:44'),
	(2, 'aguas', 'unread', 1, 1, '2014-09-01 20:38:43', '2014-09-01 20:38:43'),
	(3, 'aasgasgasgasg as ga sg asg af as fa sf asf as fa sf as fas fa sf as fasf as fas fa sfa sf as as fas asfasf asf asf asf', 'unread', 1, 1, '2014-09-01 20:42:02', '2014-09-01 20:42:02'),
	(4, 'preguntaona asfas fas f x as fas fas fa sf asf as fas fas fa sf asf as f', 'unread', 1, 1, '2014-09-01 21:04:24', '2014-09-01 21:04:24'),
	(5, 'Te llego el correo?', 'responded', 2, 2, '2014-09-01 21:37:46', '2014-09-01 21:46:17'),
	(6, 'Ahora si deberia llegar, me avisas', 'responded', 2, 2, '2014-09-01 21:43:12', '2014-09-01 21:46:04'),
	(7, '3', 'responded', 2, 2, '2014-09-01 21:44:13', '2014-09-01 21:45:36'),
	(8, 'prueba de notificaciones', 'unread', 1, 1, '2014-09-04 00:07:49', '2014-09-04 00:07:49'),
	(9, 'wefrgvwefrg 2werfwefr werfwerfwer fgwerfvwebgvw3rebfrgb bd hfnb ethn dfh net hn egtf hbw dfv wdf vwd fv wdfvw fdv w fvw efv e wefvwfe vw efv wef vw ef wef vwef vwfev wef wef vwef', 'unread', 1, 3, '2014-09-04 09:55:51', '2014-09-04 09:55:51'),
	(10, 'efrsdfgvwsdfvgasfd', 'unread', 1, 3, '2014-09-04 10:04:23', '2014-09-04 10:04:23'),
	(11, 'dfhfhdfhdfh', 'unread', 5, 2, '2014-09-16 12:10:01', '2014-09-16 12:10:01');
/*!40000 ALTER TABLE `questions` ENABLE KEYS */;


-- Volcando estructura para tabla sabuesoonline.users
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `type` enum('admin','classified','enterprise') COLLATE utf8_unicode_ci NOT NULL,
  ...
  CONSTRAINT `users_estado_id_foreign` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`),
  CONSTRAINT `users_municipio_id_foreign` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sabuesoonline.users: ~4 rows (aproximadamente)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `dni`, `phone`, `email`, `password`, `type`, `estado_id`, `municipio_id`, `remember_token`, `created_at`, `updated_at`, `profile_picture`) VALUES
	(1, 'Clasificados Eloquent', '21382657', '04246029989', 'clasificados@sabuesoonline.com', '$2y$10$mG37z6dJzZ7sEJWdxYSCGOYfpqeaPhobR.bhNwE.0C7jvP8e8NLv.', 'classified', 23, 455, '4WBrkMuJcpEmPB6x3NxeWHD2ljbM8A07A5F4vLXEoLiiOqDtklgRIuIUOtIL', '2014-08-25 17:58:05', '2014-09-09 01:03:50', ''),
	(2, 'Eli Carrasquero', '21382657', '04246029989', 'ielijose@gmail.com', '$2y$10$nhUqS.qoCmWa1afXmZzDKem4rBR.lcRlSbyuv0NPaxRohC3UJfJBi', 'classified', 23, 458, NULL, '2014-09-01 21:06:24', '2014-09-16 11:19:21', '/uploads/avatar/6tsdacswoWUQUmdO_guns_soldier_counter_terrorism_call_of_duty_black_ops_2_wallpaper-HD.jpg'),
	(3, 'Luis Padrón', '12373495', '04246349403', 'luisgpadronleon@gmail.com', '$2y$10$AerfyJ0qDi7TrLFjQ13ETOr7rPFlZZdhz9C7sAoKa9mKM1LJD6DjK', 'classified', 23, 455, '0nIVq75DuoicKK2FfahbYldj0i9jaXmii7PbGe5DSFgVu9xiMAbUYJUt2uGc', '2014-09-01 21:21:24', '2014-09-01 23:47:47', ''),
	(4, 'lplplp lplplpl', '1231231231', '21341234234234234', 'luispadronleon@hotmail.com', '$2y$10$xMxYy19LuqZApP7pNTgHQeALpH52ggiKVuUIsXuV7V.1KYsaaD9Mm', 'classified', 23, 455, NULL, '2014-09-01 23:49:05', '2014-09-01 23:49:05', '');
